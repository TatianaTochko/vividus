...
public class AbstractElementNameSearch extends AbstractWebElementSearchAction implements IElementSearchAction
{
    public AbstractElementNameSearch(IActionAttributeType actionAttributeType)
    {
