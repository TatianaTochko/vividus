...
public class BaseValidations implements IBaseValidations
{
    ...
    {
        return assertIfElementExists(businessDescription, uiContext.getSearchContext(), searchAttributes);
    }
    ...
    {
        return assertIfElementsExist(businessDescription, uiContext.getSearchContext(), searchAttributes);
    }
    ...
    public boolean assertIfExactNumberOfElementsFound(String businessDescription, SearchAttributes searchAttributes,
            int number)
    {
        return assertIfExactNumberOfElementsFound(businessDescription, uiContext.getSearchContext(),
    ...
    {
        return assertIfAtLeastNumberOfElementsExist(businessDescription, uiContext.getSearchContext(),
    ...
    {
        return assertIfAtLeastOneElementExists(businessDescription, uiContext.getSearchContext(), searchAttributes);
    }
    ...
    public Optional<WebElement> assertIfZeroOrOneElementFound(String businessDescription,
            SearchAttributes searchAttributes)
    {
        return assertIfZeroOrOneElementFound(businessDescription, uiContext.getSearchContext(), searchAttributes);
    }
    ...
    {
        return assertIfElementDoesNotExist(businessDescription, uiContext.getSearchContext(), searchAttributes,
    ...
    {
        return assertIfNumberOfElementsFound(businessDescription, uiContext.getSearchContext(), searchAttributes,
