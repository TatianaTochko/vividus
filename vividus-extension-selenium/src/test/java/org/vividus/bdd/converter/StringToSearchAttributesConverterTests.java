...
class StringToSearchAttributesConverterTests
{
    ...
    void testConvertValue()
    {
        ...
        when(conversionUtils.convertToSearchAttributes(locator)).thenReturn(searchAttributes);
        assertEquals(searchAttributes, converter.convertValue(locator, SearchAttributes.class));
    }
}
