...
class ElementActionServiceTests
{
    ...
    @ParameterizedTest
    void testFind(TestActionAttributeType type, Class<?> expectedClass)
    {
    ...
    void testFindAttributeTypeUnknown()
    {
        Exception exception = assertThrows(IllegalArgumentException.class,
            () -> service.find(TestActionAttributeType.COMPETING_FILTER));
        assertEquals("Unknown attribute type: COMPETING_FILTER", exception.getMessage());
    }
}
