...
class AbstractElementSearchActionTests
{
    ...
    @InjectMocks
    private final AbstractElementAction elementSearchAction = new AbstractElementAction(TestActionAttributeType.SEARCH)
    { };

    @Test
    void testGetAttributeType()
    {
        assertEquals(TestActionAttributeType.SEARCH, elementSearchAction.getAttributeType());
    }
